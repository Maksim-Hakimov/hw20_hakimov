...
def movie_dao():
    ...
    movie_1 = Movie(id=1, title="First Movie", description="description", trailer="link", year=2000, rating=10.0,
                    genre_id=1, director_id=1)
    movie_2 = Movie(id=2, title="Second Movie", description="description", trailer="link", year=2000, rating=10.0,
                    genre_id=1, director_id=2)
    movie_3 = Movie(id=3, title="Third Movie", description="description", trailer="link", year=2000, rating=10.0,
                    genre_id=1, director_id=1)
